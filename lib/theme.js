...
export function ThemeProvider({ children }) {
  ...
  const T = {
    ...
    green: light ? '#c2410c' : '#f89203',
    orange: light ? '#c2410c' : '#f89203',
    greenSub: light ? '#ea580c' : 'rgba(248, 146, 3,.6)',
    orangeSub: light ? '#ea580c' : 'rgba(248, 146, 3,.6)',
    border: light ? 'rgba(0,0,0,.08)' : 'rgba(248, 146, 3,.14)',
    border2: light ? 'rgba(234, 88, 12,.25)' : 'rgba(248, 146, 3,.28)',
  }
