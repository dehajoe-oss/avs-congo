...
export function ThemeProvider({ children }) {
  ...
  const T = {
    ...
    green: light ? '#9a5f22' : '#c47b2d',
    orange: light ? '#9a5f22' : '#c47b2d',
    greenSub: light ? '#a96a26' : 'rgba(196, 123, 45,.45)',
    orangeSub: light ? '#a96a26' : 'rgba(196, 123, 45,.45)',
    border: light ? 'rgba(0,0,0,.08)' : 'rgba(196, 123, 45,.14)',
    border2: light ? 'rgba(154, 95, 34,.25)' : 'rgba(196, 123, 45,.26)',
  }
