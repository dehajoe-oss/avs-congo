...
export function ThemeProvider({ children }) {
  ...
  const T = {
    ...
    green: light ? '#3d6023' : '#5a8738',
    greenSub: light ? '#15803d' : 'rgba(90, 135, 56,.6)',
    border: light ? 'rgba(0,0,0,.08)' : 'rgba(90, 135, 56,.14)',
    border2: light ? 'rgba(22,163,74,.25)' : 'rgba(90, 135, 56,.28)',
  }
