...
export function ThemeProvider({ children }) {
  ...
  const T = {
    ...
    green: light ? '#c9680a' : '#ea8025',
    orange: light ? '#c9680a' : '#ea8025',
    greenSub: light ? '#d97706' : 'rgba(234, 128, 37,.6)',
    orangeSub: light ? '#d97706' : 'rgba(234, 128, 37,.6)',
    border: light ? 'rgba(0,0,0,.08)' : 'rgba(234, 128, 37,.14)',
    border2: light ? 'rgba(201, 104, 10,.25)' : 'rgba(234, 128, 37,.28)',
  }
