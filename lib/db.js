...
export async function createUser({ fullName, name, phone, email, password, companyName = '', userType = 'individual' }) {
  ...
  try {
    const user = await prisma.user.create({
      data: {
        ...
        email: finalEmail,
        password, // En environnement de production, hashé via le backend
