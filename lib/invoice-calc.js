...
export function emptyInvoiceForm() {
  ...
  return {
    ...
    applyTimbre: true,
    deposit: 0,
    notes: 'Paiement par MTN MoMo (+242 06 967 75 67), Airtel Money (+242 05 633 70 50) ou virement bancaire. Tout retard entraîne des pénalités conformément à la réglementation en vigueur.',
    status: 'ENVOYEE',
  }
}
