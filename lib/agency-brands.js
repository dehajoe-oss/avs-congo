...
export const AGENCY_BRANDS = {
  // ── 1. MARQUE PERSONNELLE / AGENCE TECH ────────────────────────────────────
  tech: {
    id: 'tech',
    code: 'TECH',
    nom: "Agence Tech & Conseil Digital (Cybersécurité · Web · IA · Marketing)",
    pageFacebookName: "Votre Page Tech", // À personnaliser avec le nom exact de votre page
    pageFacebookId: "", // ID de votre page Facebook
    secteurs: [
