      ...
      <section style={{ padding: '2.5rem 5%', borderBottom: `1px solid ${T.border}`, background: T.light ? 'rgba(0,0,0,.02)' : 'rgba(255,255,255,.02)' }}>
        <div style={{ maxWidth: 1180, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2rem' }}>
          <div style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
            <div style={{ width: 40, height: 40, borderRadius: 10, background: T.light ? 'rgba(169, 106, 38,.1)' : 'rgba(196, 123, 45,.1)', color: T.green, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
              <Award size={20} />
            </div>
            <div>
            ...
            >
              <div>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '.8rem', marginBottom: '1rem' }}>
                  <span style={{ fontSize: '.7rem', fontWeight: 700, fontFamily: "'Poppins', sans-serif", color: T.green, background: T.light ? 'rgba(169, 106, 38,.1)' : 'rgba(196, 123, 45,.1)', padding: '.25rem .7rem', borderRadius: 6 }}>
                    {mod.category}
                  </span>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '1.2rem' }}>
              {[
                ...
                <div key={i} style={{ padding: '1.5rem', borderRadius: 16, background: T.light ? '#ffffff' : '#122415', border: `1px solid ${T.border}` }}>
                  <div style={{ width: 44, height: 44, borderRadius: 12, background: T.light ? 'rgba(169, 106, 38,.1)' : 'rgba(196, 123, 45,.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: T.green, marginBottom: '1rem' }}>
                    <step.Icon size={22} />
                  </div>
          ...
          <div style={{ background: T.light ? '#ffffff' : '#0a170d', border: `2px solid ${T.green}`, borderRadius: 20, maxWidth: 520, width: '100%', padding: '2rem', maxHeight: '90vh', overflowY: 'auto' }}>
            ...
            {submitted ? (
              <div style={{ textAlign: 'center', padding: '2rem 1rem' }}>
                <div style={{ width: 50, height: 50, borderRadius: '50%', background: 'rgba(196, 123, 45,.2)', color: T.green, display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 1rem' }}>
