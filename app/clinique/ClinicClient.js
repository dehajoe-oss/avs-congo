              ...
              {CLINIC_SERVICES.map((srv) => (
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '.8rem', marginBottom: '.4rem' }}>
                    ...
                    <span style={{ fontSize: '.7rem', fontFamily: "'Poppins', sans-serif", color: T.green, background: T.light ? 'rgba(169, 106, 38,.1)' : 'rgba(180, 112, 39,.1)', padding: '.2rem .6rem', borderRadius: 6, whiteSpace: 'nowrap' }}>
                      {srv.duration}
                    </span>
                  </div>
          ...
          <div id="rdv-form" style={{ padding: '2.2rem', borderRadius: 20, background: T.light ? '#ffffff' : '#0a170d', border: `2px solid ${T.border}`, boxShadow: T.light ? '0 10px 30px rgba(0,0,0,.04)' : '0 10px 30px rgba(0,0,0,.4)' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1.5rem', paddingBottom: '1.2rem', borderBottom: `1px solid ${T.border}` }}>
              <img 
                ...
                alt="Dr POUTYA" 
                style={{ width: 56, height: 56, borderRadius: '50%', objectFit: 'cover', objectPosition: 'center 20%', border: `2px solid ${T.green}`, boxShadow: '0 0 12px rgba(180, 112, 39,.25)' }}
              />
              <div>
            ...
            {submitted ? (
              <div style={{ textAlign: 'center', padding: '2.5rem 1rem' }}>
                <div style={{ width: 54, height: 54, borderRadius: '50%', background: 'rgba(180, 112, 39,.2)', color: T.green, display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 1rem' }}>
