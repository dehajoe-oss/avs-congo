...
function HeroContact() {
  ...
  return (
    <section style={{ height: '100vh', minHeight: 640, position: 'relative', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#0c0a09' }}>
      ...
      {/* Layer MID */}
      <div ref={layerMidRef} style={{ position: 'relative', zIndex: 10, maxWidth: 1000, padding: '72px 5% 0', textAlign: 'center', transition: 'transform .1s ease-out' }}>
...
function ContactChannels() {
  ...
  const CHANNELS = [
    ...
    { icon: Mail, label: 'Email', val: 'agrovetoservicescongo@gmail.com', href: 'mailto:agrovetoservicescongo@gmail.com', color: '#c47b2d', desc: 'Réponse sous 24h' },
    { icon: Phone, label: 'Téléphone', val: '+242 05 633 70 50 / +242 06 967 75 67', href: 'tel:+242069677567', color: '#c47b2d', desc: 'Bureau: Lun–Sam 8h–18h | Urgences 24/7' },
    { icon: MapPin, label: 'Localisation', val: "Quartier Socoprise, Av. Nelson Mandela, Rue Bissoute, Pointe-Noire", href: null, color: '#c47b2d', desc: 'Déplacements possibles en exploitation' },
  ]
    ...
    <section ref={ref} style={{ padding: 'clamp(3rem,6vw,5rem) 5% clamp(2rem,4vw,3rem)', background: T.bgAlt }}>
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        ...
        <motion.div initial={{ opacity: 0, y: 12 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ delay: .5 }}
          style={{ marginTop: '1.5rem', padding: '1rem 1.3rem', borderRadius: 14, background: 'rgba(196, 123, 45,.04)', border: `1px solid ${T.border}`, display: 'flex', alignItems: 'center', gap: '1rem', flexWrap: 'wrap' }}>
              ...
              {sent ? (
                <motion.div key="success" initial={{ opacity: 0, scale: .9 }} animate={{ opacity: 1, scale: 1 }} style={{ textAlign: 'center', padding: 'clamp(2rem,6vw,3rem) 1rem' }}>
                  <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ type: 'spring', stiffness: 300, damping: 18 }}
                    style={{ width: 72, height: 72, borderRadius: '50%', background: 'rgba(196, 123, 45,.15)', border: '2px solid rgba(196, 123, 45,.4)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 1.5rem' }}>
