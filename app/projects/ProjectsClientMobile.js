...
function HeroRealisations() {
  ...
  return (
    <section style={{ height: '100vh', minHeight: 640, position: 'relative', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#0c0a09' }}>
      ...
      {/* Layer MID */}
      <div ref={layerMidRef} style={{ position: 'relative', zIndex: 10, maxWidth: 900, padding: '72px 5% 0', textAlign: 'center', transition: 'transform .1s ease-out' }}>
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: .6 }}>
          ...
          <p style={{ fontSize: '1rem', color: 'rgba(255,255,255,.55)', lineHeight: 1.75, maxWidth: 560, margin: '0 auto 2.5rem' }}>
            Élevages avicoles, provenderie certifiée, fermes partenaires, audits QHSE… Chaque réalisation témoigne de notre engagement sanitaire et zootechnique au Congo.
          </p>
        </motion.div>
      </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ height: 280, position: 'relative', overflow: 'hidden' }}>
              ...
              <div className="no-pill-mobile" style={{ position: 'absolute', top: '1rem', right: '1rem', display: 'flex', gap: '.5rem', flexWrap: 'wrap', justifyContent: 'flex-end' }}>
                <div style={{ padding: '.28rem .8rem', borderRadius: 100, background: 'rgba(196, 123, 45,.15)', backdropFilter: 'blur(8px)', border: '1px solid rgba(196, 123, 45,.3)', fontFamily: "'Poppins', sans-serif", fontSize: '.65rem', fontWeight: 600, color: '#c47b2d' }}>
                  {project.type}
                </div>
                {project.live && (
                  <div style={{ display: 'flex', alignItems: 'center', gap: '.35rem', padding: '.28rem .8rem', borderRadius: 100, background: 'rgba(196, 123, 45,.88)', fontFamily: "'Poppins', sans-serif", fontSize: '.58rem', color: '#fff', fontWeight: 700, letterSpacing: '.06em' }}>
              ...
              {/* Résultat */}
              <div className="no-pill-mobile" style={{ position: 'absolute', bottom: '1rem', right: '1rem', padding: '.3rem .9rem', borderRadius: 100, background: 'rgba(0,0,0,.65)', backdropFilter: 'blur(8px)', border: '1px solid rgba(196, 123, 45,.3)', fontFamily: "'Poppins', sans-serif", fontWeight: 700, fontSize: '1rem', color: '#c47b2d' }}>
                {project.result}
              </div>
            </div>
            ...
            <div style={{ padding: '1.8rem 2rem' }}>
              <h3 style={{ fontSize: '1.25rem', fontWeight: 800, color: T.textMain, fontFamily: "'Poppins', sans-serif", letterSpacing: '-.02em', lineHeight: 1.2, marginBottom: '.6rem' }}>
                {project.title}
              </h3>

              <p style={{ fontFamily: "'Poppins', sans-serif", fontSize: 'clamp(.85rem,2.8vw,1rem)', fontWeight: 600, lineHeight: 1.65, color: T.textSub, marginBottom: '1.2rem' }}>{project.desc}</p>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '.5rem' }}>
                {(project.tech || []).map(t => (
                  <span key={t} style={{
                    padding: '.3rem .85rem',
                    borderRadius: 100,
                    background: 'rgba(196, 123, 45,.1)',
                    border: '1px solid rgba(196, 123, 45,.35)',
