        ...
        <div style={{ maxWidth: 780, margin: '0 auto', position: 'relative', zIndex: 1 }}>
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: .6 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '.8rem', marginBottom: '1.2rem', flexWrap: 'wrap' }}>
              <span style={{ padding: '.25rem .85rem', borderRadius: 100, background: T.light ? 'rgba(169, 106, 38,.08)' : 'rgba(196, 123, 45,.08)', border: `1px solid ${T.border}`, fontFamily: "'Poppins', sans-serif", fontSize: '.65rem', fontWeight: 600, color: T.green, display: 'flex', alignItems: 'center', gap: '.35rem' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '.75rem', marginBottom: '2rem' }}>
              <img
                ...
                style={{ width: 48, height: 48, borderRadius: '50%', objectFit: 'cover', objectPosition: 'center 20%', border: '2px solid #c47b2d', flexShrink: 0 }}
              />
              <div>
        ...
        <div style={{ maxWidth: 780, margin: '0 auto' }}>
          {content.map((block, i) => (
            <motion.div key={i}
              ...
              {block.type === 'cta' && (
                <div style={{ margin: '2.5rem 0', padding: '2rem', borderRadius: 16, background: T.light ? 'rgba(169, 106, 38,.05)' : 'rgba(196, 123, 45,.05)', border: `1px solid ${T.border}`, textAlign: 'center' }}>
