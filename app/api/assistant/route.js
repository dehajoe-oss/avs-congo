    ...
    html: `
      <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;max-width:600px;margin:0 auto;background:#0a120c;">
        ...
        <div style="padding:32px;">
          ...
          <div style="display:inline-block;padding:5px 12px;border-radius:100px;background:rgba(234, 128, 37,.12);border:1px solid rgba(234, 128, 37,.3);font-size:12px;font-weight:700;color:#fdba74;margin-bottom:24px;">
            ${projectLabel}
          </div>
          <table style="width:100%;border-collapse:collapse;margin-bottom:20px;">
            <tr>
              <td style="padding:14px 16px;background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.06);border-radius:10px 0 0 10px;border-right:none;">
                ...
                <span style="font-size:13px;color:#ea8025;font-weight:600;">${safeContact}</span>
              </td>
          ...
          <p style="color:#e8e4df;line-height:1.7;font-size:14px;background:rgba(234, 128, 37,.05);padding:18px;border-radius:10px;border-left:3px solid #ea8025;margin:0 0 8px;">
            ${safeSummary}
          </p>
        </div>
