    ...
    const result = await getResend().emails.send({
      ...
      html: `
        <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;max-width:600px;margin:0 auto;background:#0a120c;">
          ...
          <!-- Header marque -->
          <div style="padding:28px 32px;background:#1c1917;border-bottom:1px solid rgba(180, 112, 39,.25);">
            <div style="font-family:'Poppins', sans-serif;font-size:13px;font-weight:700;letter-spacing:.1em;color:#b47027;text-transform:uppercase;">
          ...
          <div style="padding:32px;">
            ...
            ${safeOrganization ? `<div style="font-size:13px;color:#b47027;font-weight:600;margin-bottom:8px;">🏢 ${safeOrganization}</div>` : ''}
            <div style="display:inline-block;padding:5px 12px;border-radius:100px;background:rgba(180, 112, 39,.12);border:1px solid rgba(180, 112, 39,.3);font-size:12px;font-weight:700;color:#8ab866;margin-bottom:24px;">
              ${projectLabel}
            </div>
            ...
            <table style="width:100%;border-collapse:collapse;margin-bottom:20px;">
              <tr>
                <td style="padding:14px 16px;background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.06);border-radius:10px 0 0 10px;border-right:none;">
                  ...
                  <a href="mailto:${safeEmail}" style="font-size:13px;color:#b47027;text-decoration:none;font-weight:600;">${safeEmail}</a>
                </td>
            ...
            <p style="color:#e8e4df;line-height:1.7;font-size:14px;background:rgba(180, 112, 39,.05);padding:18px;border-radius:10px;border-left:3px solid #b47027;margin:0 0 28px;">
              ${safeMessage}
            </p>

            <!-- CTA -->
            <a href="mailto:${safeEmail}" style="display:inline-block;padding:13px 26px;border-radius:100px;background:#b47027;color:#ffffff;font-size:13px;font-weight:700;text-decoration:none;">
          ...
          <div style="padding:18px 32px;border-top:1px solid rgba(255,255,255,.06);">
            <p style="margin:0;font-size:11px;color:rgba(255,255,255,.3);">
              Envoyé depuis agrovetoservices.cg · ${new Date().toLocaleString('fr-FR', { timeZone: 'Africa/Brazzaville' })}
            </p>
          </div>
        </div>
      `,
