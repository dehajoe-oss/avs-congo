    ...
    <div className={`agp-group ${className}`} style={{ '--agp-spacing': `${spacing}px` }}>
      ...
      <style suppressHydrationWarning>{`
        ...
        .agp-fallback {
          ...
          border-radius: 50%;
          font-size: 12px; font-weight: 800; color: #5a8738;
        ...
        .agp-tooltip-inner {
          background: #030806; border: 1px solid rgba(90,135,56,.35); border-radius: 8px;
        ...
        .agp-tooltip-arrow::before {
          ...
          background: #030806; border: 1px solid rgba(90,135,56,.35);
          transform: rotate(45deg); top: -4px; left: 50%; margin-left: -4px;
        }

        .agp-overflow {
          width: 34px; height: 34px; border-radius: 50%;
          border: 2.5px solid #030806; background: rgba(90,135,56,.2);
          display: flex; align-items: center; justify-content: center;
          font-size: 10px; font-weight: 800; color: #5a8738;
