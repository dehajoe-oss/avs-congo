  ...
  return (
    <a
      ...
      style={{
        ...
        color: '#fff', fontSize: '.8rem', fontWeight: 600,
        textDecoration: 'none', margin: '.3rem 0',
        boxShadow: '0 2px 8px rgba(234, 128, 37,.3)',
        transition: 'transform .15s, box-shadow .15s',
      }}
      onMouseEnter={e => { e.currentTarget.style.transform = 'translateY(-1px)'; e.currentTarget.style.boxShadow = '0 4px 12px rgba(234, 128, 37,.4)' }}
      onMouseLeave={e => { e.currentTarget.style.transform = 'none'; e.currentTarget.style.boxShadow = '0 2px 8px rgba(234, 128, 37,.3)' }}
    >
      <Globe size={15} />
  ...
  return (
    <a
      ...
      style={{
        display: 'inline-flex', alignItems: 'center', gap: '.5rem',
        padding: '.55rem 1rem', borderRadius: 10,
        background: 'rgba(234, 128, 37,.15)', border: '1px solid rgba(234, 128, 37,.3)',
        color: '#ea8025', fontSize: '.8rem', fontWeight: 600,
        textDecoration: 'none', margin: '.3rem 0',
        transition: 'transform .15s, background .15s',
      }}
      onMouseEnter={e => { e.currentTarget.style.transform = 'translateY(-1px)'; e.currentTarget.style.background = 'rgba(234, 128, 37,.25)' }}
      onMouseLeave={e => { e.currentTarget.style.transform = 'none'; e.currentTarget.style.background = 'rgba(234, 128, 37,.15)' }}
    >
      <ExternalLink size={15} />
      {label}
      <ExternalLink size={12} style={{ opacity: .7 }} />
      ...
      >
        <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{
            ...
            background: T.light ? 'rgba(234, 128, 37,.07)' : 'rgba(234, 128, 37,.06)',
            flexShrink: 0,
          }}>
            <div style={{
          ...
          <div style={{ padding: '.8rem', borderTop: `2px solid ${T.green}`, background: T.card, display: 'flex', gap: '.6rem', flexShrink: 0 }}>
            ...
            <button
              ...
              style={{
                ...
                background: streaming || !input.trim() ? (T.light ? 'rgba(234, 128, 37,.2)' : '#1a3320') : T.green,
                border: '2px solid #050505',
                boxShadow: '3px 3px 0px #050505',
                display: 'flex', alignItems: 'center', justifyContent: 'center',
