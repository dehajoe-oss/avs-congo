...
export default function Logo({ size = 48, animate = true, onClick, showTag = true }) {
  ...
  useEffect(() => {
    ...
    style.textContent = `
      ...
      @keyframes akaGlowPulse { 0%,100%{filter:drop-shadow(0 0 10px rgba(248, 146, 3,.5)) brightness(1)} 50%{filter:drop-shadow(0 0 28px rgba(248, 146, 3,.95)) brightness(1.05)} }
    `
