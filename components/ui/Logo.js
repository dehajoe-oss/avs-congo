...
export default function Logo({ size = 48, animate = true, onClick, showTag = true }) {
  ...
  useEffect(() => {
    ...
    style.textContent = `
      ...
      @keyframes akaGlowPulse { 0%,100%{filter:drop-shadow(0 0 10px rgba(180, 112, 39,.5)) brightness(1)} 50%{filter:drop-shadow(0 0 28px rgba(180, 112, 39,.95)) brightness(1.05)} }
    `
