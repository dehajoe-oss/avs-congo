    ...
    <div>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 12, marginBottom: 20, flexWrap: 'wrap' }}>
        ...
        <button
          ...
          style={{
            ...
            background: '#f89203', color: '#fff', border: 'none', borderRadius: 12,
            padding: '.65rem 1.3rem', fontFamily: "'Poppins', sans-serif", fontWeight: 700,
            fontSize: '.85rem', cursor: 'pointer', boxShadow: '0 4px 14px rgba(248, 146, 3, 0.35)',
          }}
        >
      ...
      {loading && products.length === 0 ? (
        ...
        <div style={{ textAlign: 'center', padding: '4rem 1rem', background: T.card, border: `1px solid ${T.border}`, borderRadius: 16 }}>
          ...
          <button onClick={openCreateModal} style={{ background: '#f89203', color: '#fff', border: 'none', borderRadius: 10, padding: '.5rem 1.2rem', fontWeight: 700, cursor: 'pointer' }}>
            Créer un produit
          </button>
        </div>
      ) : (
            ...
            >
              <div>
                <div style={{ display: 'flex', gap: 14, alignItems: 'flex-start', marginBottom: 12 }}>
                  <img
                    src={p.image || 'https://images.unsplash.com/photo-1548550023-2bdb3c5beed7?auto=format&fit=crop&w=400&q=80'}
                    alt={p.title}
                    style={{ width: 68, height: 68, borderRadius: 12, objectFit: 'cover', background: T.border, flexShrink: 0 }}
                  />
                  <div style={{ minWidth: 0, flex: 1 }}>
                    <div style={{ fontSize: '.68rem', fontWeight: 700, color: '#f89203', textTransform: 'uppercase', letterSpacing: '.05em', marginBottom: 2 }}>
                      {p.category}
                    </div>
            ...
            <form onSubmit={handleSave} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'flex-end', gap: 10, marginTop: 10 }}>
                ...
                <button
                  type="submit"
                  disabled={saving}
                  style={{ background: '#f89203', color: '#fff', border: 'none', borderRadius: 10, padding: '.6rem 1.4rem', fontWeight: 700, cursor: saving ? 'default' : 'pointer' }}
                >
