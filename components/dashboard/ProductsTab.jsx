    ...
    <div>
      ...
      {loading && products.length === 0 ? (
        ...
        <div style={{ textAlign: 'center', padding: '4rem 1rem', background: T.card, border: `1px solid ${T.border}`, borderRadius: 16 }}>
          ...
          <button onClick={openCreateModal} style={{ background: '#ea8025', color: '#fff', border: 'none', borderRadius: 10, padding: '.5rem 1.2rem', fontWeight: 700, cursor: 'pointer' }}>
            Créer un produit
          </button>
        </div>
      ) : (
              ...
              <div>
                <div style={{ display: 'flex', gap: 14, alignItems: 'flex-start', marginBottom: 12 }}>
                  ...
                  <div style={{ minWidth: 0, flex: 1 }}>
                    <div style={{ fontSize: '.68rem', fontWeight: 700, color: '#ea8025', textTransform: 'uppercase', letterSpacing: '.05em', marginBottom: 2 }}>
                      {p.category}
                    </div>
