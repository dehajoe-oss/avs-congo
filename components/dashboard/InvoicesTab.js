...
const STATUS_COLORS = { ENVOYEE: '#5b8def', PAYEE: '#b47027', ANNULEE: '#e05e5e' }
      ...
      <div>
        ...
        <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap', alignItems: 'flex-start' }}>
          ...
          <div style={{ ...CARD, padding: '1.2rem', flex: '1 1 340px', minWidth: 300, display: 'flex', flexDirection: 'column', gap: 10 }}>
            ...
            <button onClick={addLine} style={{ padding: 10, background: 'rgba(180, 112, 39,.08)', color: T.green, border: `1px dashed ${T.green}`, borderRadius: 8, fontSize: '.78rem', fontWeight: 700, cursor: 'pointer' }}>
              + Ajouter une ligne
            </button>
