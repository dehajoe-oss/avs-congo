    ...
    >
      <div
        ...
        style={{
          ...
          borderRadius: '24px',
          boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.6), 0 0 30px rgba(248, 146, 3, 0.15)',
          padding: '2rem',
          position: 'relative',
        ...
        >
          <button
            ...
            style={{
              ...
              fontWeight: 700,
              cursor: 'pointer',
              background: isRegister ? '#f89203' : 'transparent',
              ...
              <div style={{ display: 'flex', gap: '8px' }}>
                <button
                  ...
                  style={{
                    ...
                    padding: '8px',
                    borderRadius: '10px',
                    border: `1px solid ${formData.userType === 'breeder' ? '#f89203' : 'rgba(255,255,255,0.1)'}`,
                    background: formData.userType === 'breeder' ? 'rgba(248, 146, 3, 0.15)' : 'transparent',
                    color: formData.userType === 'breeder' ? '#f89203' : 'inherit',
                    fontSize: '0.75rem',
                    fontWeight: 600,
                    cursor: 'pointer',
                  }}
                ...
                <button
                  ...
                  style={{
                    ...
                    padding: '8px',
                    borderRadius: '10px',
                    border: `1px solid ${formData.userType === 'company' ? '#f89203' : 'rgba(255,255,255,0.1)'}`,
                    background: formData.userType === 'company' ? 'rgba(248, 146, 3, 0.15)' : 'transparent',
                    color: formData.userType === 'company' ? '#f89203' : 'inherit',
                    fontSize: '0.75rem',
                    fontWeight: 600,
                    cursor: 'pointer',
                  }}
