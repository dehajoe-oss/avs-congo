    ...
    >
      <div
        ...
        style={{
          ...
          borderRadius: '24px',
          boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.6), 0 0 30px rgba(234, 128, 37, 0.15)',
          padding: '2rem',
          position: 'relative',
        ...
        >
          <button
            ...
            style={{
              ...
              fontWeight: 700,
              cursor: 'pointer',
              background: isRegister ? '#ea8025' : 'transparent',
              ...
              <div style={{ display: 'flex', gap: '8px' }}>
                <button
                  ...
                  style={{
                    ...
                    padding: '8px',
                    borderRadius: '10px',
                    border: `1px solid ${formData.userType === 'breeder' ? '#ea8025' : 'rgba(255,255,255,0.1)'}`,
                    background: formData.userType === 'breeder' ? 'rgba(234, 128, 37, 0.15)' : 'transparent',
                    color: formData.userType === 'breeder' ? '#ea8025' : 'inherit',
                    fontSize: '0.75rem',
                    fontWeight: 600,
                    cursor: 'pointer',
                  }}
                ...
                <button
                  ...
                  style={{
                    ...
                    padding: '8px',
                    borderRadius: '10px',
                    border: `1px solid ${formData.userType === 'company' ? '#ea8025' : 'rgba(255,255,255,0.1)'}`,
                    background: formData.userType === 'company' ? 'rgba(234, 128, 37, 0.15)' : 'transparent',
                    color: formData.userType === 'company' ? '#ea8025' : 'inherit',
                    fontSize: '0.75rem',
                    fontWeight: 600,
                    cursor: 'pointer',
                  }}
