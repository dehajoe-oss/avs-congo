  ...
  return (
    <div className="aka-nav-container">
      <nav ref={navRef} className={'aka-card-nav' + (open ? ' is-open' : '')} style={{
        ...
        '--nav-shadow': T.light
          ? '0 12px 36px -4px rgba(0, 0, 0, 0.12), 0 0 0 1px rgba(196, 123, 45, 0.2)'
          : '0 16px 44px -4px rgba(0, 0, 0, 0.65), 0 0 0 1px rgba(196, 123, 45, 0.35)',
        '--nav-hline': '#ffffff',
        ...
        '--card1-link-hover': T.light ? '#9a5f22' : '#c47b2d',
        '--theme-green': T.light ? '#9a5f22' : '#c47b2d',
      }}>
