    ...
    >
      <div
        ...
        style={{
          ...
          borderLeft: '1px solid rgba(90, 135, 56, 0.3)',
          display: 'flex',
      ...
      >
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <div>
              <h3 style={{ margin: 0, fontSize: '1.1rem', fontWeight: 800 }}>Votre Panier AVS</h3>
            ...
            <div style={{ textAlign: 'center', padding: '2rem 1rem' }}>
              <div
                style={{
                  ...
                  height: '68px',
                  borderRadius: '50%',
                  background: 'rgba(90, 135, 56, 0.18)',
                  color: '#5a8738',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
              ...
              <div
                style={{
                  padding: '12px 20px',
                  borderRadius: '12px',
                  background: 'rgba(90, 135, 56, 0.12)',
                  border: '1px dashed #5a8738',
                  color: '#5a8738',
                  fontSize: '1.1rem',
                  fontWeight: 900,
              ...
              >
                ...
                <div>
                  ...
                  <span style={{ color: orderCompleted.paymentStatus === 'PAID' ? '#5a8738' : '#f59e0b', fontWeight: 700 }}>
              ...
              {!currentUser && (
                <div
                  style={{
                    ...
                    borderRadius: '12px',
                    background: 'rgba(90, 135, 56, 0.1)',
                    border: '1px solid rgba(90, 135, 56, 0.25)',
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'space-between',
                    fontSize: '0.78rem',
                ...
                {cartItems.map((item) => (
                  ...
                  >
                    <div style={{ flex: 1 }}>
                      ...
                      <div style={{ fontSize: '0.78rem', color: '#5a8738', fontWeight: 600 }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                    ...
                    <div
                      ...
                      style={{
                        padding: '12px',
                        borderRadius: '12px',
                        border: `2px solid ${paymentMethod === 'kkiapay' ? '#5a8738' : 'rgba(255,255,255,0.08)'}`,
                        background: paymentMethod === 'kkiapay' ? 'rgba(90, 135, 56, 0.12)' : (T.light ? '#f9fafb' : '#0e1710'),
                        cursor: 'pointer',
                        display: 'flex',
                        alignItems: 'center',
                        gap: '12px',
                    ...
                    >
                      <div
                        style={{
                          ...
                          height: '18px',
                          borderRadius: '50%',
                          border: `2px solid ${paymentMethod === 'kkiapay' ? '#5a8738' : 'rgba(255,255,255,0.3)'}`,
                          display: 'flex',
                          alignItems: 'center',
                          justifyContent: 'center',
                        }}
                      >
                        {paymentMethod === 'kkiapay' && (
                          <div style={{ width: '10px', height: '10px', borderRadius: '50%', background: '#5a8738' }} />
                        )}
                      </div>
                      <div style={{ flex: 1 }}>
                        <div style={{ fontWeight: 800, fontSize: '0.85rem', display: 'flex', alignItems: 'center', gap: '6px' }}>
                          <span>💳 KKiaPay (Mobile Money & Carte)</span>
                          <span style={{ fontSize: '0.65rem', padding: '2px 6px', borderRadius: '100px', background: '#5a8738', color: '#fff' }}>
                            Instantané
                          </span>
                        </div>
                    ...
                    <div
                      ...
                      style={{
                        padding: '12px',
                        borderRadius: '12px',
                        border: `2px solid ${paymentMethod === 'whatsapp' ? '#5a8738' : 'rgba(255,255,255,0.08)'}`,
                        background: paymentMethod === 'whatsapp' ? 'rgba(90, 135, 56, 0.12)' : (T.light ? '#f9fafb' : '#0e1710'),
                        cursor: 'pointer',
                        display: 'flex',
                        alignItems: 'center',
                        gap: '12px',
                    ...
                    >
                      <div
                        style={{
                          ...
                          height: '18px',
                          borderRadius: '50%',
                          border: `2px solid ${paymentMethod === 'whatsapp' ? '#5a8738' : 'rgba(255,255,255,0.3)'}`,
                          display: 'flex',
                          alignItems: 'center',
                          justifyContent: 'center',
                        }}
                    ...
                    <div
                      ...
                      style={{
                        padding: '12px',
                        borderRadius: '12px',
                        border: `2px solid ${paymentMethod === 'cash' ? '#5a8738' : 'rgba(255,255,255,0.08)'}`,
                        background: paymentMethod === 'cash' ? 'rgba(90, 135, 56, 0.12)' : (T.light ? '#f9fafb' : '#0e1710'),
                        cursor: 'pointer',
                        display: 'flex',
                        alignItems: 'center',
                        gap: '12px',
                    ...
                    >
                      <div
                        style={{
                          ...
                          height: '18px',
                          borderRadius: '50%',
                          border: `2px solid ${paymentMethod === 'cash' ? '#5a8738' : 'rgba(255,255,255,0.3)'}`,
                          display: 'flex',
                          alignItems: 'center',
                          justifyContent: 'center',
                        }}
        ...
        {showSandboxFallback && (
          ...
          >
            <div style={{ width: '56px', height: '56px', borderRadius: '50%', background: 'rgba(90, 135, 56, 0.2)', color: '#5a8738', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '1rem' }}>
              <CreditCard size={28} />
            </div>
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                justifyContent: 'center',
                gap: '8px',
                boxShadow: '0 10px 25px -5px rgba(90, 135, 56, 0.4)',
              }}
            >
              {isSubmitting ? (
                'Traitement en cours...'
